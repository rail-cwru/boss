...
Lazily created second file to avoid switching hassle.
"""
import argparse
import os
import sys
...
GRAPHS4 = (['4k', '4box', '4ring', '4spoon', '4star', '4line'],
...
def train_trial(use_nodes, graphname, adjlist, overwrite):
    json_path = './experiment_configs/TrainGridBattle.json'
...
def modify_data_get_trialname(train_data, graphname, adjlist, use_nodes):
    ...
    name = 'GridBattle44_' + nodename + graphname
    return name
