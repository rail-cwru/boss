...
This class has been modified to contain two hierarchies, one for action selection and one for derived samples generation
"""


class AuxiliaryEnvInfoTwoHierarchies(object):
