...
from domain.features import DiscreteFeature, RealFeature
...
class MountainCar(Environment):
    ...
    def __init__(self, config: Config):
        self.wrapped_env = gym.make('MountainCar-v0')
    ...
    def update(self, actions: Dict[int, np.ndarray]) -> Dict[int, int]:
        ...
        # Adjust for convergence, common practice
        if self._current_observation[0] >= 0.5:
            reward += 100
