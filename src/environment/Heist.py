...
class Heist(HierarchicalEnvironment):
    """
    A state-based representation of the Heist environment
    The agent must obtain keys to open locks in order to reach a gem
    The locks and keys must be obtained in a specific order, as the green key is only obtainable after
    opening the blue lock

    This was inspired by the Procgen library: https://openai.com/blog/procgen-benchmark/
    """
    ...
    def __init__(self, config: 'Config'):
        ...
        self._flat = True
        super(Heist, self).__init__(config)
